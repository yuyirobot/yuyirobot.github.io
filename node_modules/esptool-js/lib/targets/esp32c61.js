...
export class ESP32C61ROM extends ESP32C6ROM {
    constructor() {
        ...
        this.TEXT_START = ESP32C61_STUB.text_start;
        this.ENTRY = ESP32C61_STUB.entry;
        this.DATA_START = ESP32C61_STUB.data_start;
        this.ROM_DATA = ESP32C61_STUB.data;
        this.ROM_TEXT = ESP32C61_STUB.text;
